  ...
  return (
    <div className="px-[10rem] py-[4rem]">
        ...
        <div className="mt-12 flex flex-col   gap-7">
            ...
            <div className=" grid grid-cols-[90px_1fr_1fr_1fr_100px_4px] shadow-[0px_10px_10px_-10px_#48549F1A]  items-center   bg-[#FFFFFF] rounded-lg px-[32px] py-[22px] gap-20">
                <h1 className="text-[15px] font-bold">{invoice.id}</h1>
                    ...
                    <button className="text-[#0C0E16] text-[15px] font-bold px-2 py-2 rounded-md border-solid border">
                        <span className=" h-[8px] w-[8px] rounded-md inline-block border-solid border mr-1.5"></span>{invoice.status}
                    </button>
