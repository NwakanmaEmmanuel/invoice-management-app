...
const invoices: Invoice[] = [
  ...
  },
  {
    ...
    status: 'Pending',
    senderAddress: { street: '19 Union Terrace', city: 'London', postCode: 'E1 3EZ', country: 'United Kingdom' },
    clientAddress: { street: '3 Big Cat Lane', city: 'Gotham', postCode: 'DC1 2WE', country: 'United States' },
    items: [
      { name: 'Design', quantity: 1, price: 6155.91, total: 6155.91 },
    ],
    total: 6155.91,
  },
  {
    ...
    items: [
      { name: 'Logo Sketches', quantity: 1, price: 3102.04, total: 3102.04 },
    ],
    total: 3102.04,
  },
];
